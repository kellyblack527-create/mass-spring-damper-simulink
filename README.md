...
A dynamic simulation of a second-order mass-spring-damper system built in MATLAB Simulink, driven by a sinusoidal external force.
System Overview
The system models a mass connected to a fixed wall via a spring and damper, subjected to an external force f(t).
Governing Equation:
mẍ + cẋ + kx = f(t)
Parameters
ParameterValueMass (m)2 kgDamping coefficient (c)2 N.s/mSpring stiffness (k)8 N/mExternal force f(t)2sin(2t) N
